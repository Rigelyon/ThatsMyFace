...
from internal_pages.test_sections.watermarking_embed_test import display_watermark_embed_test
from internal_pages.test_sections.watermarking_extract_test import display_watermark_extract_test
...
def display_test_development_page(debug_mode=False):
    ...
    test_tabs = st.tabs(["Face Encrypt and Decrypt", "Helper Data Comparison", "Watermark Embedding Test", "Watermark Extracting Test"])
